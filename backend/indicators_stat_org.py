...
plt.tight_layout()
plt.savefig(r'C:\Users\22390\Desktop\OpenSODA\backendData\indicators_histogram.png', dpi=100, bbox_inches='tight')
plt.close()
...
plt.tight_layout()
plt.savefig(r'C:\Users\22390\Desktop\OpenSODA\backendData\indicators_top10_bar.png', dpi=100, bbox_inches='tight')
plt.close()
